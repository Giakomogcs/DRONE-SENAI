...
class Tello_2:
    ...
    def __init__(self):
        ...
        self.video = cv2.VideoCapture("rtmp:10.84.30.42:1935/")
    ...
    def infos(self):
        global frame, key, ids, past, rload, cod, myData, past, LocalProps,DataPL
        i = 0
        pd = False
        lc = False
        rload = False
            ...
            try:
                ...
                if ret:
                    ...
                    for barcode in decode(frame):
                        ...
                        if myData != '' and (DataPL == 'Local' or DataPL == 'Produto') and (myData not in past): #verifica se existe o codigo lido no excel
                            #mycolor = (0,255,0) 
...
def scan(data): 
    global DataPL, loc, Dloc, prod, filtroLRua, filtroLNivel, filtroLColuna, LocalProps, mycolor
    DataPL = ''
