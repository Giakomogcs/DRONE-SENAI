...
class Tello_2:
    ...
    def infos(self):
        global frame, key, ids, past, rload,cod
        i = 0
        pd = False
        lc = False
        rload = False
...
def post_msg():
    ...
    filtroP = cod['Codigo'] == ids[0] #Produto
    prod = cod[filtroP].iloc[0,1]

    filtroL = cod['Codigo'] == ids[1] #Local
    loc = cod[filtroL].iloc[0,2]

    prat = "Pratileira OpenLab"
...
cod = pd.read_excel(r"C:\Drone\codigos_GS1.xlsx", engine='openpyxl')
