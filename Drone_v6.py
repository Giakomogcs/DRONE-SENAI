                ...
                if ret:
                    ...
                    for barcode in decode(frame):
                        ...
                        if myData in MydataList:
                            ...
                            if (myData not in past):

                                if (myData not in ids):

                                    if ((myData in MydataListg) and (pd == False)):
                                        ids.append(myData) #produto
                                        pd = True
                                        
                                    elif ((myData in MydataListh) and (lc == False)):
                        ...
                        cv2.putText(frame,myData,(pts2[0],pts2[1]),cv2.FONT_HERSHEY_PLAIN,1,(mycolor),5, cv2.LINE_AA)
